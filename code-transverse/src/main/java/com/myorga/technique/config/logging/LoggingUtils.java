package com.myorga.technique.config.logging;
...
import com.myorga.technique.config.ProjectProperties.Logging;
import com.myorga.technique.config.ProjectProperties.Logging.Logstash;
...
public final class LoggingUtils {
    ...
    public static void addLogstashTcpSocketAppender(LoggerContext context, String customFields, Logstash logstashProperties) {
    ...
    private static class LogbackLoggerContextListener extends ContextAwareBase implements LoggerContextListener {
        private final Logging loggingProperties;
        private final String customFields;

        private LogbackLoggerContextListener(Logging loggingProperties, String customFields) {
