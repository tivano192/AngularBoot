...
import com.myorga.technique.config.cache.PrefixedKeyGenerator;
...
public class CacheConfiguration {
    ...
    public CacheConfiguration(ProjectProperties ProjectProperties) {
        ProjectProperties.Cache.Ehcache ehcache = ProjectProperties.getCache().getEhcache();
