package com.myorga.code.rest.errors;

import com.myorga.code.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.myorga.code.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.myorga.code.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    public ProblemBuilder prepare(final Throwable throwable, final StatusType status, final URI type) {
        ...
        if (activeProfiles.contains(ProjectConstants.SPRING_PROFILE_PRODUCTION)) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.myorga.code");
    }
}
