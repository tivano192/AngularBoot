...
describe('Alert service test', () => {
  describe('Alert Service Test', () => {
    ...
    it('should produce an alert object with correct id', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello Application info' });
      expect(service.addAlert({ type: 'success', message: 'Hello Application success' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello Application success',
          id: 1,
        } as Alert)
      );
    ...
    it('should close an alert correctly', inject([AlertService], (service: AlertService) => {
      const alert0 = service.addAlert({ type: 'info', message: 'Hello myApplication info' });
      const alert1 = service.addAlert({ type: 'info', message: 'Hello myApplication info 2' });
      const alert2 = service.addAlert({ type: 'success', message: 'Hello myApplication success' });
      expect(alert2).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello myApplication success',
          id: 2,
        } as Alert)
      );
      ...
      expect(service.get()[1]).not.toEqual(
        expect.objectContaining({
          type: 'info',
          message: 'Hello Application info 2',
          id: 1,
        } as Alert)
      );
    ...
    it('should clear alerts', inject([AlertService], (service: AlertService) => {
      service.addAlert({ type: 'info', message: 'Hello Application info' });
      service.addAlert({ type: 'danger', message: 'Hello Application info' });
      service.addAlert({ type: 'success', message: 'Hello Application info' });
      expect(service.get().length).toBe(3);
      service.clear();
      expect(service.get().length).toBe(0);
    }));
    ...
    it('should produce a success message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello Application' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello Application',
        } as Alert)
    ...
    it('should produce a success message with custom position', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'success', message: 'Hello Application', position: 'bottom left' })).toEqual(
        expect.objectContaining({
          type: 'success',
          message: 'Hello myApplication',
    ...
    it('should produce a error message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'danger', message: 'Hello Application' })).toEqual(
        expect.objectContaining({
          type: 'danger',
          message: 'Hello myApplication',
        } as Alert)
    ...
    it('should produce a warning message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'warning', message: 'Hello Application' })).toEqual(
        expect.objectContaining({
          type: 'warning',
          message: 'Hello myApplication',
        } as Alert)
    ...
    it('should produce a info message', inject([AlertService], (service: AlertService) => {
      expect(service.addAlert({ type: 'info', message: 'Hello Application' })).toEqual(
        expect.objectContaining({
          type: 'info',
          message: 'Hello myApplication',
        } as Alert)
    ...
    it('should produce a info message with translated message if key exists', inject(
      ...
      (service: AlertService, translateService: TranslateService) => {
        translateService.setTranslation('en', {
          'hello.myApplication': 'Translated message',
        });
        expect(service.addAlert({ type: 'info', message: 'Hello Application', translationKey: 'hello.myApplication' })).toEqual(
          expect.objectContaining({
            type: 'info',
    ...
    it('should produce a info message with provided key if transltion key does not exist in translations and message is not provided', inject(
      [AlertService, TranslateService],
      (service: AlertService) => {
        expect(service.addAlert({ type: 'info', translationKey: 'hello.myApplication' })).toEqual(
          expect.objectContaining({
            type: 'info',
            message: 'hello.myApplication',
          } as Alert)
